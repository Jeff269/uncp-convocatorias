...
@Component({
  selector: 'app-admin-postulantes-plaza',
  templateUrl: './admin-postulantes-plaza.component.html',
  styleUrls: ['./admin-postulantes-plaza.component.css']
})
export class AdminPostulantesPlazaComponent implements OnInit {
